...
Modified to use an improved filename generator for AudioMoth recordings. Goes
straight to using CRC24 hash code to avoid repeated checks for name clashes
which occurs using the standard approach.
...
void crc24(DWORD *crc, WORD word) {
